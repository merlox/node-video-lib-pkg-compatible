...
module.exports = {
    ...
    createAtom: function createAtom(type) {
        const rootLocation = path.dirname(process.execPath)
        const location = path.join(rootLocation, 'node_modules', 'node-video-lib', 'lib', 'mp4', 'atoms', `atom-${type}.js`)
        let AtomClass = require(location);
